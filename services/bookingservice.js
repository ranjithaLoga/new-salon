...
exports.addBooking= (query, cb) => {
    ...
    Booking.create(queryobj).then((data) => {
...
exports.getStylistBooking = (id, cb) => {
    ...
    console.log("stylistId",stylistId )
     var statement ="SELECT bookings.date, bookings.location, salons.name FROM salons, bookings WHERE bookings.salon_id=salons.id AND bookings.stylist_id=:stylist_id";
